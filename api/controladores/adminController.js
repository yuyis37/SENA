...
// adminController.listarUrlamigable = function(request,response){
//   var post={
//     rutaamigable:request.body.rutaamigable
//   }
//   if(post.rutaamigable == null || post.rutaamigable == undefined || post.rutaamigable =='' ){
//     response.json({state:false,mensaje:'no se reconoce la ruta'})
//     return false;
//   }
//  adminModel.listarUrlamigable(post,function(respuesta){
//    response.json(respuesta)
//  }) 
// }
adminController.actualizar = function(request,response){
